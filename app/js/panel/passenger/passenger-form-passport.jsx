...
export default React.createClass({
	...
	render() {
		...
		return (
			<div className={'passenger-add-passport ' + this.state.visible}>
					...
					<div className="iscroll-scroller full-width">
						...
						<form>
							...
							<ul className="passenger-ul">
								...
								<li className="ps-block ud-l">
									<PassengerInput title="Passport No." placeholder="ex.27483507" inputType="text"></PassengerInput>
								</li>
